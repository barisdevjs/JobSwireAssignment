  ...
  return (
    <>
      <div className="posts">
        ...
        <div onClick={() => [handleToggle(2), navigate('/reels')]} className={isActive === 2 ? 'reels selected' : 'reels'}>
          <img src={require('../Images/Kullanılacak assetler/video.png')} alt="symbol" />
          <h3>Reels</h3>
        </div>
        <div onClick={() => [handleToggle(3), navigate('/tagged')]} className={isActive === 3 ? 'tagged selected' : 'tagged'}>
